...
int divisao_inteira_resto(float num1, float num2, float *resp, float *resto); 
                                                                                // Aqui adicionamos o desafio de retornar a divisão com retorno inteiro, descartando o resto.
